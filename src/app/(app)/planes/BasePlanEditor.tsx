...
// module isn't paid for — every gym still gets exactly one base Plan from
// onboarding, and needs a way to see/edit it (price changes, a typo from
// onboarding, etc.) without unlocking the paid feature. No create/delete/
// featured controls here — those only make sense with more than one plan.
    ...
    <div className="flex flex-col gap-6">
      ...
      {!plan ? (
        <div className="rounded-2xl border border-border bg-surface p-10 text-center text-sm text-muted-foreground">
          Todavía no hay un plan configurado. Contactanos para dejarlo listo.
        </div>
      ) : (
        <div className="max-w-lg rounded-2xl border border-border bg-surface p-7">
          ...
          <form action={action.bind(null, plan.id)} className="flex flex-col gap-4">
            <div>
