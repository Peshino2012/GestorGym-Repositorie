      ...
      {created && (
        <div className="animate-pop-in rounded-2xl border border-success/30 bg-success-bg p-5">
          ...
          <p className="mt-1 text-sm text-success">
            Contraseña temporal: <span className="font-mono font-bold">{DEFAULT_STAFF_PASSWORD}</span> —
            se le va a pedir que la cambie al iniciar sesión por primera vez.
          </p>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-2xl border border-border bg-surface p-6">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Se crea como Staff con una contraseña temporal.
          </p>
