import { requirePlanAccess } from "@/lib/authz";
...
// separate from "/planes" (the paid multi-plan module), with its own
// permission (canAccessPlan) independent of canAccessPlanes. Every gym
// gets exactly one plan from onboarding and needs a way to see/edit it
// (or create it, if it somehow doesn't exist yet) with no dependency on
